...
// CoreForgeTables returns the list of CoreForge tables that need RLS.
...
func (m *Migrator) GenerateMigrationSQL() string {
	...
	sb.WriteString("-- CoreForge RLS Migration\n")
	sb.WriteString("-- Generated by github.com/grokify/coreforge/rls\n\n")
...
func (m *Migrator) GenerateRollbackSQL() string {
	...
	var sb strings.Builder
	sb.WriteString("-- CoreForge RLS Rollback\n\n")

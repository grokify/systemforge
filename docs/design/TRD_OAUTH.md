...
### Phase 6: AcademyOS Integration (Week 6)

| Task | Description | Files |
|------|-------------|-------|
| 6.1 | Mount OAuth endpoints | `academyos/internal/api/oauth.go` |
| 6.2 | Developer portal API | `academyos/internal/api/developer.go` |
| 6.3 | Migration scripts | `academyos/migrations/*.sql` |
| 6.4 | Integration tests | `academyos/internal/api/*_test.go` |
| 6.5 | Documentation | `academyos/docs/oauth.md` |

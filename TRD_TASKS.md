...
**Estimate**: 0.5 day
**Files**:
- `dashforge/ent/schema/` (new files or mixins)
...
**Estimate**: 1 day
**Files**:
- `dashforge/migrations/migrate_to_coreforge.sql`
- `dashforge/cmd/migrate/main.go`
...
**Estimate**: 2 days
**Files**:
- `dashforge/internal/server/auth/` (refactor)
- `dashforge/internal/server/server.go`
...
**Estimate**: 1 day
**Files**:
- `dashforge/tests/auth_test.go`
- `dashforge/tests/bff_test.go`
